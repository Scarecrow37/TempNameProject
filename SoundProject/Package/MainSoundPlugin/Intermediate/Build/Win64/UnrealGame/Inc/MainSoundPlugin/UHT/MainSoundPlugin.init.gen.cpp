...
void EmptyLinkFunctionForGeneratedCodeMainSoundPlugin_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_MainSoundPlugin()
	{
		if (!Z_Registration_Info_UPackage__Script_MainSoundPlugin.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_MainSoundPlugin_MusicSFXDelegate__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_MainSoundPlugin(Z_Construct_UPackage__Script_MainSoundPlugin, TEXT("/Script/MainSoundPlugin"), Z_Registration_Info_UPackage__Script_MainSoundPlugin, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xEA32D7D4, 0x0A161C9F));
